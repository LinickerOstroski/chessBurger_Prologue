...
namespace chessBurger
{
    ...
    {
        MySqlConnection conexao = new MySqlConnection("server=localhost;user id=root;password=;database=chess");
     ...
     ////
        ...
        public int verificaID(string user, string pass)
        {
            ...
            string connectionString = "server=localhost;user id=root;password=;database=chess";
